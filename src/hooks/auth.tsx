...
function AuthProvider({ children }: AuthProviderProps) {
  ...
  async function signIn(email: string, password: string){
    ...
    .then(account => {
      ...
      .catch(() => Alert.alert('Login', 'Não foi possível bucar os dados de perfil do usuário'))
  ...
  async function forgotPassword(email: string) {
    ...
    .catch(() => Alert.alert('Redefnir senha', 'Não foi possível enviar o e-mail para redefinir a senha'))
    .finally(() => setIsLogging(false))
  }
